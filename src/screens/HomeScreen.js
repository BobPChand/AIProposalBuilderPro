    ...
    <SafeAreaView style={styles.container}>
      <ScrollView contentContainerStyle={styles.scroll}>
        <View style={styles.header}>
          ...
          <Text style={styles.title}>AI Proposal Builder Pro</Text>
        ...
        <TouchableOpacity style={styles.actionCard} onPress={() => navigation.navigate('Proposals')}>
          ...
          <View style={styles.actionText}>
            <Text style={styles.actionTitle}>Build a Proposal</Text>
            <Text style={styles.actionDesc}>Professional proposals tailored to any client</Text>
          </View>
        ...
        <TouchableOpacity style={styles.actionCard} onPress={() => navigation.navigate('Proposals', { screen: 'pitch' })}>
          ...
          <View style={styles.actionText}>
            <Text style={styles.actionTitle}>Create a Pitch Deck</Text>
            <Text style={styles.actionDesc}>Investor-ready pitch outlines in seconds</Text>
          </View>
          <Ionicons name="chevron-forward" size={20} color="#C7C7CC" />
        </TouchableOpacity>
        ...
        <TouchableOpacity style={styles.actionCard} onPress={() => navigation.navigate('History')}>
          <View style={[styles.actionIcon, { backgroundColor: '#EAFBF0' }]}>
            <Ionicons name="time" size={22} color="#34C759" />
          </View>
          <View style={styles.actionText}>
            <Text style={styles.actionTitle}>Proposal History</Text>
            <Text style={styles.actionDesc}>View and reuse past proposals</Text>
          </View>
          <Ionicons name="chevron-forward" size={20} color="#C7C7CC" />
        </TouchableOpacity>

        <TouchableOpacity style={styles.actionCard} onPress={() => navigation.navigate('Settings')}>
          <View style={[styles.actionIcon, { backgroundColor: '#F0F0F5' }]}>
            <Ionicons name="settings" size={22} color="#8E8E93" />
          </View>
          <View style={styles.actionText}>
        ...
        <View style={styles.tipCard}>
          ...
          <Text style={styles.tipText}>Tip: Include the client's industry and project budget for the most tailored proposal.</Text>
        </View>
      </ScrollView>
    </SafeAreaView>
  );
...
const styles = StyleSheet.create({
  ...
  iconBadge: { width: 64, height: 64, borderRadius: 18, backgroundColor: '#4A90E2', justifyContent: 'center', alignItems: 'center', marginBottom: 12 },
  ...
  tipText: { flex: 1, fontSize: 13, color: '#4A90E2', lineHeight: 18 },
});
